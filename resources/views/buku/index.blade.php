...
<table class="table table-hover mt-2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('buku.edit', $data->id_buku) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>

                <!-- Button trigger modal -->
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $data->id_buku }}">
                    Hapus
                </button>
